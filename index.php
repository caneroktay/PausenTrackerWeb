...
<body>
    ...
    <div class="container">
        <div class="header">
            <div></div>
            <img class="logo-img" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='white' stroke-width='2'%3E%3Ccircle cx='12' cy='12' r='10'/%3E%3Cpolyline points='12 6 12 12 16 14'/%3E%3C/svg%3E" alt="">
    ...
    <script>
        ...
        // Eğer schedule boşsa, GFN standard'ı yükle
